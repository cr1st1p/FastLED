...
/*
 * Code from NeoPixelBus implementation of the DMA method.
 * Also, some changes from https://github.com/coryking/FastLED
 */
...
#    pragma message "Using DMA-based RGB controller as per FASTLED_RGB define"
#else
#    warning "Using DMA-Based RGB controller as per FASTLED_RGB define"
#endif
...
public:
    ...
    virtual CLEDController & setLeds(CRGB *data, int nLeds) override {
    	CPixelLEDController<RGB_ORDER>::setLeds(data, nLeds);
        this->InitI2S();
        return *this;
    }
    ...
    void InitI2S()
    {
    	Serial.println(__PRETTY_FUNCTION__); // DEBUG:
